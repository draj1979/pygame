...
class Ground(pygame.sprite.Sprite):
    def __init__(self, groups):
        ...
        self.image=pygame.transform.scale(ground_surf,pygame.math.Vector2(ground_surf.get_size())*1.6)
...
class Plane(pygame.sprite.Sprite):
    ...
    def import_frames(self):
        self.frames=[]
        for i in range(3):
            surf=pygame.image.load(f'./FlappyBird/graphics/plane/red{i}.png').convert_alpha()
...
class Obstacles(pygame.sprite.Sprite):
    def __init__(self,groups):
        ...
        self.image=pygame.transform.scale(surf,pygame.math.Vector2(surf.get_size())*1.6)
